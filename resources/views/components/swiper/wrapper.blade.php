...
<div class="swiper {{ $containerClass ?? '' }}">
  ...
  <a 
    href="javascript:;" 
    class="js-swiper-prev lg:p-32 absolute z-90 top-1/2 -translate-y-1/2 left-10 {{ $type == 'landing' ? 'lg:left-[calc(16.666%_+_3px)]' : 'lg:left-[calc(25%)]' }}">
  ...
  <a 
    href="javascript:;" 
    class="js-swiper-next lg:p-32 absolute z-90 top-1/2 -translate-y-1/2 right-16 {{ $type == 'landing' ? 'lg:right-[calc(16.666%_+_3px)]' : 'lg:right-[calc(25%)]' }}">
